import { version, unref, inject, defineComponent, ref, provide, createElementBlock, h, shallowReactive, watch, Suspense, nextTick, Transition, useSSRContext, createApp, effectScope, reactive, hasInjectionContext, getCurrentInstance, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, mergeProps } from 'vue';
import { $ as $fetch, w as withQuery, l as hasProtocol, p as parseURL, m as isScriptProtocol, n as joinURL, h as createError$1, o as defu, q as sanitizeStatusCode, r as createHooks, t as isSamePath, v as toRouteMatcher, x as createRouter$1, y as ofetch } from '../runtime.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-BixESNJM.mjs').then((m) => m.default || m)
  }
];
...
function isDev() {
  var _a;
  return typeof process !== "undefined" && (((_a = process.env) == null ? void 0 : _a.NODE_ENV) === "development" || false);
}
...
const vue_tailwind_datepicker_Witns8p0r2 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const ofetch_TmnSnS1Swe = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  let __temp, __restore;
  globalThis.$fetch = ([__temp, __restore] = executeAsync(() => ofetch.create({
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B0pkRz1A.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-BK0AaEvb.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useRuntimeConfig as a, navigateTo as b, asyncDataDefaults as c, useNuxtApp as d, entry$1 as default, createError as e, hF as f, getException as g, hVue2 as h, injectHead as i, getAttrsForVueVersion as j, isVue2 as k, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, sleep as s, throwException as t, useRouter as u };
